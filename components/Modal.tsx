      ...
      <Dialog.Portal>
        ...
        >
          ...
          <Dialog.Close asChild>
            <button className="text-neutral-400 hover:text-white absolute top-[10px] right-[10px] inline-flex h-[25px] w-[25px] items-center justify-center rounded-full appearance-none focus:outline-none">
                <IoMdClose/>
            </button>
          </Dialog.Close>
        </Dialog.DialogContent>
